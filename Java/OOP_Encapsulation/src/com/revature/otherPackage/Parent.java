...
public class Parent {
	...
	// When using private variables, as is good practice, you should also provide getters and/or
	// setters, depending on how you want developers to interact with your variables
