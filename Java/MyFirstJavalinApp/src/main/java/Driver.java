...
public class Driver {
    public static void main(String[] args) {
        ...
        //Creates a Javalin server object , and starts listening on
        //port 7070
        ...
        //Can also break up the definition of the listener/path
        //and the code to run once a message is received, by storing the
        //lamda in a variable (which we do on line 26)
